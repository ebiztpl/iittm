...
<div>
  ...
  <table width="100%">
    <tr>
      <td align="center" > <h3><span style="font-size: 20px;">(Under Collaborative Scheme with JNU, New Delhi)</span><br/><b>MBA (Tourism & Travel) 2025-27</b></h3></td>
...
<td><label>Age (As on 1 July 2020) </label>
...
<b>
  <?php
      ...
      echo $diff->format('%y')."Year ".$diff->format('%m')."Month ".$diff->format('%d')."Days" ;
...
Exam Date : <b><?php echo $rst['score_year']??'' ? date('d-m-Y', strtotime($rst['score_year'])) : 0; ?></b> 
...
<td>
<b>
  <img src="https://ebiztechnocrats.com/iittm_2025/uploads/MBA/"<?php echo $users['candidate_signature']; ?> width="100">
</b>
...
<td>
<img src="https://ebiztechnocrats.com/iittm_2025/uploads/MBA/"<?php echo $users['candidate_photo']; ?> width="100">
</td>
</tr>
