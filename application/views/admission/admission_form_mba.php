...
<div id="loader-wrapper">
  ...
  <div class="container container_bg">
    ...
    <div class="row text-center">
      <h3><b>Online Admission Form for MBA (Tourism & Travel Management) 2025-27 Programme</b> <br/><span style="font-size: 20px;">(Under Collaborative Scheme with JNU, New Delhi)</span></h3>
      <hr/>
    </div> 
...
<fieldset class="form_disable">
 ...
 <fieldset class="form_disable">
    ...
    <div class="row">
      <div class="col-sm-6">
        <span style="font-size: 19px;"> Submit a valid scorecard of appeared entrance test between June 1, 2024 to May 31, 2025:</span>
      </div>
      <div class="col-sm-6">
        <div class="row">
...
<fieldset class="form_disable">
  ...
  <div class="row">
    ...
    <div class="col-sm-4">
     <span style="font-size: 19px;"> Choice of centre for appearing in GD & PI for above-mentioned entrance test/IIAT-2025 (offline)</span>
    </div>
   ...
   else
   {
    ...
    var today = new Date("01 Jul 2023 23:59:59 GMT");
      ...
      console.log(year_age);
        ...
        //  if((caterogry !="SC" || caterogry !="ST") && year_age >= 28)
         // {
