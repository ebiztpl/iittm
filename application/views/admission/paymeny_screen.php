...
<div class="main">
  <div class="container container_bg">
    ...
    <div class="row text-center">
      <h3><b>
      <?php 
       if($rstE['course_id']==1){echo "Online Admission for BBA(TT/2025-28)";}  
        if($rstE['course_id']==2){echo "Online Admission for MBA(TTM/2025-27)";}
      ?>
    </b></h3>
      <hr/>
    </div> 
	...
	<div class="col-sm-12">
      <form name="razorpay-form" id="razorpay-form" action="payment_status_without_fee" method="POST">
          <input type="hidden" name="razorpay_payment_id" id="razorpay_payment_id" value="withoutfee" />
          <input type="hidden" name="user_id" id="user_id" value="<?php echo $userid; ?>"/>
          <input type="hidden" name="course_id" id="course_id" value="<?php echo $rstE['course_id']; ?>"/>
      ...
      <span style="font-size:25px; color:red;">
        In view of Admission Drive for the academic year 2025-2026, for promotional purposes, it is <br/>hereby notified that the Registration Fee for Admission Forms at IITTM will be waived off <br/>for the months of January 2025 to March 2025 During this period, <br/>applicants can register without any charges.
      </span>
        ...
        <div class="col-sm-12 text-center" style="margin-top:30px;">
          ...
          <div class="form-group has-feedback text-center" id="verify_otp">
            <!--   <input  id="submit-pay" type="submit" onclick="razorpaySubmit(this);" value="Pay <?php echo $amt; ?>/-" class="btn btn-primary btn-lg" /> -->
               <input id="submit-pay" type="submit" value="Register Now" class="btn btn-primary btn-lg" />
          </div>
