            ...
            <div class="col-sm-6">
                <div class="box box-danger">   
                    <div class="box-header with-border">
                      <h3 class="box-title">Select Any One</h3>
                    </div>
                    <div class="box-body box-danger">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                            <div class="radio">
                              <label>
                                <input type="radio" ng-model="sms" name="sms" value="sms">
                                SEND LINK BY TEXT SMS
                              </label>
                            </div>

                            <div class="radio">
                              <label>
                                <input type="radio" ng-model="whatsapp" name="whatsapp" value="whatsapp">
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" ng-model="email" name="email" value="email">
                                SEND LINK BY EMAIL
                              </label>
                            </div>
                        </div>
                      ...
                      <div class="row" ng-show="sms">
                        <div class="col-sm-12">
                             <div class="radio">
                              <label>
                                <input type="radio" ng-model="all" name="sms_group" value="all">
                                All Candidate
                              </label>
                            </div>
                            ...
                            <div class="radio">
                              <label>
                                <input type="radio" ng-model="candidate" name="sms_group" value="candidate">
                                Custom Message to All Candidate
                              </label>
                            </div>

                            <div class="radio">
                              <label>
                                <input type="radio" name="sms_group" value="other">
                                Custom Message to Other
                              </label>
                            </div>
                        </div>
                      </div>
                      ...
                      <div class="row" ng-show="candidate">
                        <div class="col-sm-12">
