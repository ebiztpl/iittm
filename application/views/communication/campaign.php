                            ...
                            <thead>
                              ...
                              <tbody>
                                ...
                                foreach ($result as $key => $list) { $i ++; 
                                   ...
                                   $arry_data =  $this->db->select('*')->from('responses')->where('campaign_id',$list->id)->get()->result();
                                    $ul = "<ul style='text-align:left; margin:0px;'>";
                                    foreach ($arry_data as $keys => $respons) {
                                        $ul .= '<li>'.$respons->name.'</li>'; 
                                    }
                                    $ul .= "</ul>";
                                  ...
                                  ?>
                                   <tr>
                                    ...
                                    <?php if($arry_data){?> Response- <i class="fa fa-info-circle tooltipss"  data-toggle="tooltip" data-align="left" data-html="true" data-placement="top" title="<?=$ul ?>"></i> <?php }?>
                                    </td>
