      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          ...
          ?>  
            ...
            <div class="col-sm-12">
            <input type="hidden" value="<?php echo $userdat['user_id'] ?>" name="user_id" id="user_id" /> 
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" placeholder="Type here, what need to change in form" rows="5" name="form_desc" required=""></textarea>
            </div>
            <button  class="btn btn-info btn-lg" id="btnSubmit" name="btnSubmit" style="margin: 2px;"><i class="fa fa-upload"></i> Submit</button>

            <a href="candidate_dashboard" class="btn btn-danger btn-lg" style="margin: 2px;"><i class="fa fa-arrow-left"></i> Back</a>
            </div>
