        ...
        <div class="content-wrapper">
                                        ...
                                        <ul class="list-group list-group-unbordered">
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{study_center1}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(study_center1/1000)*100}}%'>{{study_center1}}
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{study_center2}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(study_center2/1000)*100}}%'>{{study_center2}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{study_center3}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(study_center3/1000)*100}}%'>{{study_center3}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{study_center4}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(study_center4/1000)*100}}%'>{{study_center4}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{study_center4}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(study_center5/1000)*100}}%'>{{study_center5}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <a class="pull-right" href="dashboard_filter/study_center_goa/{{course}}">{{study_center5}}</a>
                                                    </div>
                                                </div>
                                        ...
                                        <ul class="list-group list-group-unbordered">
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{gdpi_center_1}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(gdpi_center_1/1000)*100}}%'>{{gdpi_center_1}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{gdpi_center_2}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(gdpi_center_2/1000)*100}}%'>{{gdpi_center_2}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{gdpi_center_3}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(gdpi_center_3/1000)*100}}%'>{{gdpi_center_3}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{gdpi_center_4}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(gdpi_center_4/1000)*100}}%'>{{gdpi_center_4}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <li class="list-group-item">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <div class='progress'>
                                                            <div class='progress-bar progress-bar-success progress-bar-striped active' role='progressbar' aria-valuenow='{{gdpi_center_5}}' aria-valuemin='0' aria-valuemax='100' style='width: {{(gdpi_center_5/1000)*100}}%'>{{gdpi_center_5}}
                                                                <span id='current-progress'></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-sm-1">
                                                        <a class="pull-right" href="dashboard_filter/gdpi_center_goa/{{course}}">{{gdpi_center_5}}</a>
                                                    </div>
                                                </div>
                                            </li>
                        ...
                        <div class="box box-primary">
                            ...
                            <div class="box-body no-padding">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li><a href="dashboard_filter/notinterested/{{course}}"><i class="fa fa-user"></i> Not Interested Candidate<span class="label label-primary pull-right" style="color: #000; font-size: 15px;">
                                                {{notinterested}}
                                            </span></a></li>
                        ...
                        <div class="box box-info">
                            ...
                            <div class="box-body no-padding">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li>
                                        <a href="#"><i class="fa fa-users"> Not Intrested</i>
                                            <span class="label label-info pull-right" style="font-size: 15px;">{{gdpi_notint}}</span>
                                        </a>
                                    </li>

                                    <li>
                                        <a href="#"><i class="fa fa-users"> Admission</i>
                                            <span class="label label-info pull-right" style="font-size: 15px;">{{admission}}</span>
                                        </a>
                                    </li>
                        ...
                        <div class="box box-danger">
                            ...
                            <div class="box-body no-padding">
                                <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class=""><a href="dashboard_filter/duplicate/{{course}}"><i class="fa fa-users"></i> Duplicate <span class="label label-danger pull-right" style="font-size: 15px;">{{duplicate}}</span></a></li>

                                    <li><a href="dashboard_filter/incomplete_not_interested/{{course}}"><i class="fa fa-user"></i> Not Interested Candidate <span class="label label-danger pull-right" style="color: #000; font-size: 15px;">
                                                {{in_not_interested}}
                                            </span></a></li>
            ...
            <script type="text/javascript">
                ...
                function validateCtrl($scope, $log, $http) {
                    ...
                    $scope.duplicate = <?php echo $duplicate ?>;
                    $scope.bulklead = <?php echo $bulklead ?>;
                    ...
                    $scope.today_fee = <?php if ($today_fee == '') {
                                            echo 0;
                                        } else {
                                            echo $today_fee;
                                        } ?>;
                    ...
                    $scope.study_center5 = <?php echo $study_center5 ?>;
                    ...
                    $scope.gdpi_center_5 = <?php echo $gdpi_center_5 ?>;
                    ...
                    $scope.candidate = function($event) {
                        ...
                        var data = google.visualization.arrayToDataTable([
                            ['Date', 'Total Candidate'], <?php echo $candidate ?>
                        ]);
                    ...
                    $scope.get_course = function($event) {
                        ...
                        $http({
                            method: "get",
                            dataType: 'html',
                            url: "<?php echo site_url('admin/get_course_data?data='); ?>" + data
                            ...
                            // $scope.bulklead = response.data['bulklead'];
                            ...
                            $scope.study_center5 = response.data['study_center5'];
                            ...
                            $scope.gdpi_center_5 = response.data['gdpi_center_5'];
